...
function check_grad(encdec, network)
  local x, dC = network:getParameters()
...
function check_example()
  ...
  local enc_layers = {
    [1] = { layer_type = "RecurrentLayer", depth = 2 },
    --[2] = { layer_type = "AttentionSkipLSTMLayer", skip = 2 }
  }
  local dec_layers = {
    [1] = { layer_type = "RecurrentLayer", depth = 2  } ,
    --[2] = { layer_type = "AttentionSkipLSTMLayer", skip = 2 },
    [2] = { layer_type = "PredictionLayer" }
  }
  local encdec = EncoderDecoder(init_params, enc_layers, dec_layers)
  encdec.encoder:random_init()
  encdec.decoder:random_init()
